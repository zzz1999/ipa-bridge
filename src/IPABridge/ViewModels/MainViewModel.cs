...
public sealed class MainViewModel : ObservableObject, IDisposable
{
    ...
    public MainViewModel()
    {
        ...
        NavigationItems =
        [
            new NavigationItem { Label = "Overview", Glyph = "\uE80F", Page = NavigationPage.Dashboard, IsActive = true },
            new NavigationItem { Label = "App Store", Glyph = "\uE719", Page = NavigationPage.Store },
            new NavigationItem { Label = "IPA Library", Glyph = "\uE8B7", Page = NavigationPage.Library },
            new NavigationItem { Label = "Devices", Glyph = "\uE8B2", Page = NavigationPage.Devices },
